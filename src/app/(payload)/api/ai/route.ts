    ...
    switch (mode) {
      case 'generate':
        systemMessage =
          ...
          'Пиши красивые, информативные описания на русском языке. ' +
          'Используй эмодзи уместно. Форматируй текст: заголовки, списки, выделения. ' +
          'Отвечай только текстом описания без вводных фраз.'
        userMessage = prompt
        break
      ...
      case 'expand':
        systemMessage =
          ...
          'добавь деталей и глубины. Отвечай только расширенным текстом.'
        userMessage = content
        break
